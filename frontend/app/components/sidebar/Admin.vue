   ...
   <div class="max-w-3xs w-full h-screen flex flex-col items-baseline gap bg-dark-theme-900 border-r border-dark-theme-800 font-mono text-dark-theme-50">
      ...
      <div class="w-full h-screen py-4 px-2 flex flex-col items-baseline gap-0.5">
         ...
         <div
            ...
            :class="{
               'bg-dark-theme-800/50': active('/admin/beranda'),
            }">
            <NuxtLink to="/admin/beranda" class="flex flex-row gap-2 text-base tracking-tight">
               <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                  <rect width="24" height="24" fill="none" />
         ...
         <div
            class="w-full py-1.5 px-2 rounded-md hover:bg-dark-theme-800/50 hover:cursor-pointer"
            :class="{
               'bg-dark-theme-800/50': active('/admin/kasir'),
            }">
            <NuxtLink to="/admin/kasir" class="flex flex-row gap-2 text-base tracking-tight">
               <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                  <rect width="24" height="24" fill="none" />
         ...
         <div
            class="w-full py-1.5 px-2 rounded-md hover:bg-dark-theme-800/50 hover:cursor-pointer"
            :class="{
               'bg-dark-theme-800/50': active('/admin/laporan'),
            }">
            <NuxtLink to="/admin/laporan" class="flex flex-row gap-2 text-base tracking-tight">
               <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                  <rect width="24" height="24" fill="none" />
                  <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.5">
